...
(function () {
  ...
  */
  ...
  lib.renderAlbum =  function (tp) {
    var alb = idv.data.albums[tp];
    var imtp = alb.image;
    var im = idv.data.images[imtp];
    if (lib.hasTag(im,lib.whichGallery)) {
      var imdiv =  new lib.largeImDiv(lib.cDiv,im,null,alb);
      imdiv.render();
    }
  }
  ...
  lib.largeImDiv.prototype.render = function () {
    ...
    var uname = sp[2];
    //var s3d = "http://imagediver.s3-website-us-east-1.amazonaws.com/resized/"
    var s3d = "http://"+idv.cfDomain + "/images/";

  //  imUrl = "http://imagediver.com/resized/"+uname+"/"+imname+".jpg";
    var imUrl = s3d +uname+"/"+imname+"/resized/area_250000.jpg";
    var albUrl = util.publishedUrl(album.topic);
   ...
   // var ht = Math.floor(uwd * dim.y/dim.x);
    ...
    cnt.append(titleDiv);
    titleDiv.append(titleP);
    titleDiv.click(function () {util.navigateToPage(albUrl);});
    ...
    imDiv.click(function () {util.navigateToPage(albUrl);});
...
//    var imEls = '<img class="galleryImage" width="100%" height="'+htPercent+'" src="'+imUrl+'"/>';
 ...
 //   var imEls = '<img class="galleryImage" width="100%" height="'+imHt+'" src="'+imUrl+'"/>';
  ...
  lib.genDivs = function () {
    ...
    var outerDiv = $(".outerDiv");//"<div class='outerDiv'/>");
    ...
    lib.tabGroup = lib.genTab(outerDiv,cb);
    /*
    var tabCss = 
  ...
  var tabDeselectedCss = util.extend(util.copy(tabCss),{ "background-color":"#303132","color":"white"})
    ...
    tabGroup.selectElement("art");
    */
    /*
    showArt.css(tabCss);
    tabDiv.append(showArt);
   var showOther = $('<span class="clickableElement">Other</span>');
    showOther.css(tabCss);
    tabDiv.append(showArt);
    tabDiv.append(showOther);
    lib.selectClickable(showArt);
    */
...
//     var LimDiv2= new lib.largeImDiv(cDiv,lib.images.cg_mulberry_1,null,lib.albums.cg_mulberry_1_1);
 //   LimDiv2.render();
    ...
    LimDiv3.render();
 */
    lib.tabGroup.selectElement("art");
