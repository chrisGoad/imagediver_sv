   ...
   lib.albumDetailsDiv =
    $('<div class="albumDetailsDiv">' +
       ...
       '<table id="albumFields">' +
          ...
          "an ImageDiver page for each album (this is one such page).  Each image also has its own page, linked to above.</p>" +
          "</div>"+
...
'<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>';
  lib.editPermissions = function () {
    return (idv.loggedInUser == lib.albumD.owner) && (!lib.published);
  }
  //lib.tweetButtonText = ''; 
  ...
  lib.genFullTitle = function  () {
    if (lib.thisIsHomePage) {
      ...
      fullTitle = imt + author + ":" + lib.albumD.caption;
    }
    return fullTitle;
  }
...
*/
  ...
  lib.genDivs = function () {
    ...
    */
    ...
    var embed = idv.embed;
    var title = lib.genFullTitle();
    var topbarOptions = {title:util.sanitize(title),embed:embed,detailsLink:{text:"album details",action:lib.popAlbumDetails},includeGallery:1};
    if (twoC) {
