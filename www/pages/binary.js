...
function interpolate_color(r,g,b,steps,cstep) {
  var fr = cstep/steps;
  var rs = fr * r;
  var gs = fr * g;
  var bs = fr * b;
  return mkRgb(rs,gs,bs);
}

function colors3(n,steps) {
  for (var i=0;i<n;i++) {
    ctab.push(interpolate_color(255,255,255,steps,i));
  }
}


function colors4(n,m) {
...
// colors(5,4) is not bad
  ...
  */
  ...
  function fillGap(gp,v) {
    ...
    while (pw2 < gsz) {
      var idx0 = lb + pw2 -1;
      idx0c = idx2coords(idx0);
      lib.grid[idx0] = v;
      var idx1 = ub - pw2 - 1;
      idx1c = idx2coords(idx1);
      lib.grid[idx1] = v;
 ...
 var toData = function () {
   var d = lib.ctx.canvas.toDataURL();
   location.href = d;
 }
