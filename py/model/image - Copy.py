...
class ImageD(models.Descriptor):
  mytype = "/type/imageD"
...
class Tile:
  ...
  #def cropImage(im,rct,outfile,targetWidth=None,targetHeight=None,targetArea=None,exactSize=False):
...
im = image.loadImageD('/image/4294b0e/the_ambassadors')
